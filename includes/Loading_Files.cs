...
namespace LauncherSAMPInt
{
    public partial class Loading_Files : MetroFramework.Forms.MetroForm
    {
        ...
        {
            if (Directory.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\GTA San Andreas User Files"))
            {
                string settings_path = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\GTA San Andreas User Files\\settings.set";
