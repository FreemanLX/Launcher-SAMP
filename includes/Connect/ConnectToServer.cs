...
{
          public partial class ConnectToServer : MetroForm
          {
               ...
               /// <param name="dns">Server's DNS</param>
               /// <param name="ping">Server's Ping</param>
               /// <param name="username">Player's Username</param>
               /// <param name="port">Server's port</param>
               /// <param name="password">Server's password</param>
                          ...
                          string password = "No")
               {
                          ...
                          pingLabel.Text = ping;
                          portLabel.Text = port;
                          statusLabel.Text = password;
                          dnsLabel.Text = dns;
                          if (password == "Password")
                             passwordLabel.Text = "Yes";
                          else
                             passwordLabel.Text = "No";
                          if (password == "Offline")
                              connectTextLabel.Enabled = false;
                          else
                              connectTextLabel.Enabled = true;
               ...
               private void Connect_Click(object sender, EventArgs e)
               {
                    if (IsSAMPAvailable(Data.reading["Location"]))
                    {
                          ...
                          {
                               "-c", "-h", ipLabel.Text, "-p", portLabel.Text, "-n", username
                          };
